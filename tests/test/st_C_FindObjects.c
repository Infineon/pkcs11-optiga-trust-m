...
void st_c_test_find_objects_info_valid_001(void) {
    ...
    do {
        ...
        if (rv != CKR_OK) {
            printf(
                "C_FindObjectsInit failed with Response Code :%lx at line Number : %d\n",
                rv,
                __LINE__
            );
            break;
        ...
        if (rv != CKR_OK) {
            printf(
                "C_FindObjects failed with Response Code :%lx at line Number : %d\n",
                rv,
                __LINE__
            );
            break;
        ...
        if (rv != CKR_OK) {
            printf(
                "C_FindObjectsFinal failed with Response Code :%lx at line Number : %d\n",
                rv,
                __LINE__
            );
            break;
