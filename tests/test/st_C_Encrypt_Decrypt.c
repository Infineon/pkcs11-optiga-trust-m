...
void st_c_encrypt_decrypt_rsa_1024_valid_001() {
    ...
    do {
        ...
        if (rv != CKR_OK) {
            printf(
                "C_EncryptInit failed with Response Code :%x at line Number : %d\n",
                rv,
                __LINE__
            );
            break;
        ...
        if (ciphertext_len != 128) {
            printf(
                "C_Encrypt ciphertext_len mismatch:%x at line Number : %d\n",
                ciphertext_len,
                __LINE__
            );
            break;
        ...
        if (rv != CKR_OK) {
            printf(
                "C_DecryptInit failed with Response Code :%x at line Number : %d\n",
                rv,
                __LINE__
            );
            break;
        ...
        if (ciphertext_len != 128) {
            printf(
                "C_Decrypt deciphertext_len mismatch:%x at line Number : %d\n",
                ciphertext_len,
                __LINE__
            );
            break;
