...
* \author Infineon AG
*
* \file c_unit_helper.h
*
* \brief This file defines the structures used in the framework for adding suite to cunit.
*/
#ifdef _DEBUG
#define AUTOMATION 0
#else
...
{CU_ASSERT(exp == act)\
if(act != exp)\
{printf("Return Value is =%d",act);	break;}}
